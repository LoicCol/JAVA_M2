...
import com.example.myapp.conf.RestTemplateConfig;
...
@SpringBootTest(classes = MyappApplication.class, webEnvironment = DEFINED_PORT)
    ...
    public void setup() {
        ...
        list = answerRepository.saveAll(
                IntStream
                        ...
                        .mapToObj(i -> new Answer(i, "value" + i))
